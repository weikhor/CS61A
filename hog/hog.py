...
def is_swap(player_score, opponent_score):
    ...
    if (player_score>=100):
        ...
        player_score_ones = player_score%10
        player_score_tens = player_score//10
    ...
    if (opponent_score>=100):
        ...
        opponent_score_ones = opponent_score%10
        opponent_score_tens = opponent_score//10
         

    if abs(player_score_ones-player_score_tens) == abs(opponent_score_ones-opponent_score_tens):
        return True
    else:
        return False
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while (score0 < goal and score1 < goal):
        if player == 0:
            gain = take_turn(strategy0(score0,score1), score1, dice)
            score0 = score0 + gain
            player = other(player)
        else:
            gain = take_turn(strategy1(score1,score0), score0, dice)
            score1 = score1 + gain
            player = other(player)
    ...
    def helper(score0, score1):
        if (who == 0):
            ...
            if (gain > previous_high):
                print(str(gain) + " point(s)! That's the biggest gain yet for Player 0" )
                return announce_highest(who, gain, score0)
            return announce_highest(who, previous_high, score0)
        else:
            gain = score1 - previous_score
            if (gain > previous_high):
                print(str(gain) + " point(s)! That's the biggest gain yet for Player 1" )
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while (num_rolls<=10):
        ...
        score = average_fn(num_rolls, dice)
        if (max_average < score):
            max_average = score
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    free_score = free_bacon(opponent_score)+score
    
    if is_swap(free_score, opponent_score):
        if (opponent_score > free_score):
            return 0
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    ...
    if (swap_strategy(score, opponent_score, margin, num_rolls)==0):
        return 0
    elif (free_bacon(opponent_score)>=(100-score)):
        return 0
    else:
        return  num_rolls
