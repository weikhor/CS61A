...
def scheme_read(src):
    ...
    if val == 'nil':
        ...
        # BEGIN PROBLEM 7
        #got see github ans to find the pair of ''hello and expression.first
        "*** YOUR CODE HERE ***"
...
def read_tail(src):
            ...
            if (first == '(' ):
                ...
                if src.current() == ')':
                   ...
                   return ans
                    ...
                    raise SyntaxError('have more than one item after the dot')
    ...
    # END PROBLEM 2
            ...
            #if (src.current() == '('):
            #    return Pair(src.remove_front(), Pair(scheme_read(src)))
